...
describe('Computer database tests - adding computer validation', () => {
    ...
    it('Check validation texts', () => {
        ...
        expect(addComputerPage.computerNameValidationText).toEqual("Required",
            "Validation text doesn't equals text: Required.");
        expect(addComputerPage.introducedDateValidationText).toEqual("Date ('yyyy-MM-dd')",
            "Validation text doesn't equals text: Date ('yyyy-MM-dd').");
        expect(addComputerPage.discontinuedDateValidationText).toEqual("Date ('yyyy-MM-dd')",
            "Validation text doesn't equals text: Date ('yyyy-MM-dd').");
    });
